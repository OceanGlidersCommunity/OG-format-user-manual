...
|N_CALIB |N_CALIB = <int value>; |Number of calibrations.
|=================================================================================================================================================================================================================================================================
...
|SENSOR_CALIBRATION_SENSOR a|
string SENSOR_CALIBRATION_SENSOR(N_CALIB)

SENSOR_CALIBRATION_SENSOR:long_name = “sensor being calibrated”;
 |highly desirable - ISO 8601

|SENSOR_CALIBRATION_LINK a|
