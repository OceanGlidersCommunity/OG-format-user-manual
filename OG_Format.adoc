...
|network |A network is a grouping of platforms, crossing the boundaries of the program. It can represent a mutualized scientific objective, a geographical focus, an array and, a project. Multiple networks can be separated by commas. |suggested |
...
* Networks: Integrated Ocean Observing System (IOOS), Caribbean Coastal Ocean Observing System (CARICOOS), Boundary Ocean Observing Network (BOON), OceanGliders OceanGliders Storms, AtlantOS
