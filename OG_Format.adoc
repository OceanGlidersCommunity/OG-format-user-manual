...
* Variables use the standard_names attribute following CF 1.10 taken from the CF standard names tablefootnote:[https://cfconventions.org/Data/cf-standard-names/current/src/cf-standard-name-table.xml].
