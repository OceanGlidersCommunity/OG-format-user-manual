...
|data_url |A URL link to the source of this OG1.0 data file. |mandatory | **ex.:** https://linkedsystems.uk/erddap/files/Public_OG1_Data_001/Kelvin_20231205/Kelvin_620_R.nc
