...
This section contains information about the parameters measured by the glider or derived from glider measurements. The section is based on the fomrat used in
Argo formats and enbales parameter information interoperbility with CMEMS.
