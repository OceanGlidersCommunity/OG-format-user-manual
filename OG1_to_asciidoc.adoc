...
http://vocab.nerc.ac.uk/collection/L06/current/[_http://vocab.nerc.ac.uk/collection/L06/current/_]

 |mandatory |“Autonomous Underwater Vehicle”
|platform_vocabulary |Controlled vocabulary for the names used in the "platform" attribute. |mandatory |http://vocab.nerc.ac.uk/collection/L06/current/27/[_http://vocab.nerc.ac.uk/collection/L06/current/27/_]
...
|agency_role_vocabulary |The controlled vocabulary of the role used in the agency’s role. Multiple vocabularies are separated by commas. |operating agency vocabulary is mandatory |http://vocab.nerc.ac.uk/collection/C86/current/[_http://vocab.nerc.ac.uk/collection/C86/current/_]
...
Networks = “MOOSE, BOON, Water Transformation”
______________________________________________
...
Note: FIELD_COMAPRISON_REFERENCE is applicable to deployment, recovery, and delayed versions.
...
<PARAM>:vocabulary = “http://vocab.nerc.ac.uk/collection/OG1/current/[_http://vocab.nerc.ac.uk/collection/OG1/current/_] ";
...
|platform |yes |http://vocab.nerc.ac.uk/collection/L06/current/25/[_http://vocab.nerc.ac.uk/collection/L06/current/25/_] |NVS |OceanGliders
