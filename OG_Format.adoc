...
|network |A network is a grouping of platforms, crossing the boundaries of the program. It can represent a mutualized scientific objective (Boundary Ocean Observing Network, OceanGliders Storms), a geographical focus (MARACOOS, MOOSE, PAP), an array (OSNAP, CUGN), a project (MOSES, Alter Eco). Multiple networks can be separated by commas. |suggested |
