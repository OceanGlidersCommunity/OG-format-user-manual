...
LATITUDE_GPS:units = “decimal degree north”;
...
LONGITUDE_GPS:units = “decimal degree east”;
...
LATITUDE:units = “decimal degrees_north”;
...
LONGITUDE:units = “decimal degrees_east”;
