...
|mandatory |**ex.:**  http://vocab.nerc.ac.uk/collection/L06/current/27/[_ http://vocab.nerc.ac.uk/collection/L06/current/27/_]
|id a|
...
|contributing_institutions_role_vocabulary |The controlled vocabulary of the role used in the institution's role. Multiple vocabularies are separated by commas. |Operator vocabulary is mandatory |**ex.:**  http://vocab.nerc.ac.uk/collection/W08/current/[_ http://vocab.nerc.ac.uk/collection/W08/current/_]
