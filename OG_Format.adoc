...
* Format follows the ACDD 1.3footnote:[https://wiki.esipfed.org/Attribute_Convention_for_Data_Discovery_1-3] convention.
...
* unit127_20200512T001245_delayed
* sg287_20180715T012451_delayed
* sea022_20150923T150451_R
...
Where <platform_serial> refers to the serial number of the glider, with the manufacturer prefix (e.g. sea637), <start_date> refers to the deployment start UTC date under iso 8601,

Ex : sg637_20210909T1605

If the glider has no <platform_serial> use <platform_serial_number> instead to create the TRAJECTORY
