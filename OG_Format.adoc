...
|contributor_role |Role of the contributors to the glider mission. Multiple contributors’ roles are separated by commas. |PI vocabulary is mandatory | **ex.:** "PI, Data scientist"
|contributor_role_vocabulary |Controlled vocabulary for the roles used in the "contributors_role". Multiple contributors’ roles and vocabularies are separated by commas. |PI vocabulary is mandatory |**ex.:** "https://vocab.nerc.ac.uk/collection/W08/current/CONT0004/, https://vocab.nerc.ac.uk/collection/W08/current/CONT0006/"
|contributing_institutions |Names of institutions involved in the glider mission. Multiple institutions are separated by commas. |Operator is mandatory | **ex.:** Voice of the Ocean
|contributing_institutions_role |Role of the institutions involved in the glider mission. Multiple institutions' roles are separated by a comma. |Operator role is mandatory | **ex.:** Operator
|contributing_institutions_role_vocabulary |The controlled vocabulary of the role used in the institution's role. Multiple vocabularies are separated by commas. |Operator vocabulary is mandatory | **ex.:** https://vocab.nerc.ac.uk/collection/W08/current/CONT0003/
