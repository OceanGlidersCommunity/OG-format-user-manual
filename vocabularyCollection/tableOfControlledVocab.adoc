...
|Metadata fields | link to reference collection | Link to host | Governance | 
  ...
  | platform | https://vocab.nerc.ac.uk/collection/L06/current/25/ |  https://vocab.nerc.ac.uk/collection/L06/current/25/ | OceanGliders |
  | oceangliders_site | *tbd* |  *tbd* | OceanOPS |
  | contributors_role | [collection](https://github.com/OceanGlidersCommunity/OG-format-user-manual/blob/vturpin-patch-3-VocabularyCollectionSection/vocabularyCollection/contributors_role.md) |  *tbd* | OceanGliders |
