...
To request a new entry in any of the collection listed below, you should submit an issue to this repository entitle `*_"new entry for table_ <name of the vocabulary>"_*` . 
