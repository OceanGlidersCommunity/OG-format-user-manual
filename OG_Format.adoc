...
The global attribute section is used for data discovery. The following global attributes should appear in the global section. The NetCDF Climate and Forecast (CF) Metadata Conventions are available from: https://cfconventions.org/Data/cf-conventions/cf-conventions-1.8/cf-conventions.html#_single_trajectory[_https://cfconventions.org/Data/cf-conventions/cf-conventions-1.8/cf-conventions.html#_single_trajectory_]. It is recommended that extra global attributes follow ACDD convention".
...
|Conventions |A comma-separated list of the conventions that are followed by the dataset. |mandatory |ex.: "CF-1.8, ACDD-1.3, OG-1.0"
|=====================================================================================================================================================================================================================================================================================
...
<X>: these fields are specified in the control vocabularies. The fill value should have the same data type as the variable and be outside of the range of possible data values.
