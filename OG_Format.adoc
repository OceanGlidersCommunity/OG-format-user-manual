...
////
== File naming convention
OG1.0 data files should follow the naming convention :
...
DEPLOYMENT_DATE:convention = “ISO 8691”;
...
DEPLOYMENT_LATITUDE:convention = "decimal degree";
...
DEPLOYMENT_LONGITUDE:convention = "decimal degree";
...
PARAMETER:parameter_sensor_vocabulary = "TBD"; 
