...
|Metadata fields | link to reference collection | Link to host | Governance | 
  ...
  | rtqc_method | https://github.com/OceanGlidersCommunity/OG-format-user-manual/blob/vturpin-patch-3-VocabularyCollectionSection/vocabularyCollection/rtqc_method.md[collection] |  *tbd* | OceanGliders |
